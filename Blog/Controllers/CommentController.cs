...
namespace Blog.Controllers
{
    public class CommentController : Controller
    {
        ...
        {
            var comment = db.Comment.Include(c => c.Blogs).Include(c => c.User);
        ...
        public ActionResult Create([Bind(Include = "YorumId,AdSoyad,Icerik,Tarih,Email,Onay,UserId,BlogId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "YorumId,AdSoyad,Icerik,Tarih,Email,Onay,UserId,BlogId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
